...
void XMLScene::parsingGlobal(){
	parsingGlobalGlobals();
	parsingGloballighting();
	parsingGlobalCulling();
}

void XMLScene::parsingGlobalGlobals(){
	if (globElement == NULL)
...
void XMLScene::parsingGlobalCulling(){
...
void XMLScene::parsingGloballighting(){
